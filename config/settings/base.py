...
# settings/ 폴더 안에 있으므로 부모의 부모(BASE_DIR)를 가리켜야 합니다.
...
# ... 나머지 기존 설정들(MIDDLEWARE, TEMPLATES 등)을 그대로 복사해 넣으세요.
MIDDLEWARE = [
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'no-reply@family-news.local')
